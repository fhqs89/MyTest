...
@Service
public class TestZkOperateServiceImpl implements Watcher,TestZkOperateService,InitializingBean{
	...
	public String createNode() {
		...
		try {
			...
			list = zk.getChildren(NODE_NAME, this);
	...
	public void process(WatchedEvent event) {
		System.out.println("111==   "+JSONObject.toJSONString(event));
	}
