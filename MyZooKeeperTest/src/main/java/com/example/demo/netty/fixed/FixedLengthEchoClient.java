package com.example.demo.netty.fixed;
...
public class FixedLengthEchoClient {
    ...
    public final static String REQUEST = "Mark,Lison,Peter,James,Deer";//一般定长的分割，消息是固定的，不会变
        ...
        protected void initChannel(Channel ch) throws Exception {
            ...
            ch.pipeline().addLast(
                    new FixedLengthFrameDecoder(
                            FixedLengthEchoServer.RESPONSE.length()));//client是server的定长
